            ...
            :data $ {}
              ...
              |v $ %{} :Expr (:at 1550310026756) (:by |root)
                :data $ {}
                  ...
                  |y $ %{} :Expr (:at 1749876381795) (:by |BkEynDYgM)
                    :data $ {}
                      |T $ %{} :Leaf (:at 1749876383195) (:by |BkEynDYgM) (:text |:f-json)
                      |b $ %{} :Expr (:at 1749876385823) (:by |BkEynDYgM)
                        :data $ {}
                          |T $ %{} :Leaf (:at 1749876389964) (:by |BkEynDYgM) (:text |let)
                          |b $ %{} :Expr (:at 1749876390585) (:by |BkEynDYgM)
                            :data $ {}
                              |T $ %{} :Expr (:at 1749876391516) (:by |BkEynDYgM)
                                :data $ {}
                                  |T $ %{} :Leaf (:at 1749876392684) (:by |BkEynDYgM) (:text |f)
                                  |b $ %{} :Expr (:at 1749876422253) (:by |BkEynDYgM)
                                    :data $ {}
                                      |T $ %{} :Leaf (:at 1749876422558) (:by |BkEynDYgM) (:text |new)
                                      |b $ %{} :Leaf (:at 1749876422974) (:by |BkEynDYgM) (:text |Formatter)
                          |h $ %{} :Expr (:at 1749876508602) (:by |BkEynDYgM)
                            :data $ {}
                              |D $ %{} :Leaf (:at 1749876511506) (:by |BkEynDYgM) (:text |.!toString)
                              |T $ %{} :Expr (:at 1749876428678) (:by |BkEynDYgM)
                                :data $ {}
                                  |D $ %{} :Leaf (:at 1749876435046) (:by |BkEynDYgM) (:text |.!Serialize)
                                  |T $ %{} :Leaf (:at 1749876429635) (:by |BkEynDYgM) (:text |f)
                                  |b $ %{} :Expr (:at 1749876546336) (:by |BkEynDYgM)
                                    :data $ {}
                                      |D $ %{} :Leaf (:at 1749876547494) (:by |BkEynDYgM) (:text |to-js-data)
                                      |T $ %{} :Leaf (:at 1749876440925) (:by |BkEynDYgM) (:text |data)
        |display-types $ %{} :CodeEntry (:doc |)
          :code $ %{} :Expr (:at 1550221443470) (:by |root)
            :data $ {}
              ...
              |r $ %{} :Expr (:at 1749876260348) (:by |BkEynDYgM)
                :data $ {}
                  |T $ %{} :Leaf (:at 1749876260348) (:by |BkEynDYgM) (:text |[])
                  |b $ %{} :Expr (:at 1749876260348) (:by |BkEynDYgM)
                    :data $ {}
                      |T $ %{} :Leaf (:at 1749876260348) (:by |BkEynDYgM) (:text |::)
                      |b $ %{} :Leaf (:at 1749876260348) (:by |BkEynDYgM) (:text |:json)
                      |h $ %{} :Leaf (:at 1749876260348) (:by |BkEynDYgM) (:text "|\"JSON")
                  |h $ %{} :Expr (:at 1749876260348) (:by |BkEynDYgM)
                    :data $ {}
                      |T $ %{} :Leaf (:at 1749876260348) (:by |BkEynDYgM) (:text |::)
                      |b $ %{} :Leaf (:at 1749876260348) (:by |BkEynDYgM) (:text |:cirru-edn)
                      |h $ %{} :Leaf (:at 1749876260348) (:by |BkEynDYgM) (:text "|\"Cirru EDN")
                  |l $ %{} :Expr (:at 1749876260348) (:by |BkEynDYgM)
                    :data $ {}
                      |T $ %{} :Leaf (:at 1749876260348) (:by |BkEynDYgM) (:text |::)
                      |b $ %{} :Leaf (:at 1749876260348) (:by |BkEynDYgM) (:text |:json5)
                      |h $ %{} :Leaf (:at 1749876260348) (:by |BkEynDYgM) (:text "|\"JSON5")
                  |o $ %{} :Expr (:at 1749876260348) (:by |BkEynDYgM)
                    :data $ {}
                      |T $ %{} :Leaf (:at 1749876260348) (:by |BkEynDYgM) (:text |::)
                      |b $ %{} :Leaf (:at 1749876260348) (:by |BkEynDYgM) (:text |:f-json)
                      |h $ %{} :Leaf (:at 1749876260348) (:by |BkEynDYgM) (:text "|\"Fractured")
                  |q $ %{} :Expr (:at 1749876260348) (:by |BkEynDYgM)
                    :data $ {}
                      |T $ %{} :Leaf (:at 1749876260348) (:by |BkEynDYgM) (:text |::)
                      |b $ %{} :Leaf (:at 1749876260348) (:by |BkEynDYgM) (:text |:cson)
                      |h $ %{} :Leaf (:at 1749876260348) (:by |BkEynDYgM) (:text "|\"CSON")
                  |s $ %{} :Expr (:at 1749876260348) (:by |BkEynDYgM)
                    :data $ {}
                      |T $ %{} :Leaf (:at 1749876260348) (:by |BkEynDYgM) (:text |::)
                      |b $ %{} :Leaf (:at 1749876260348) (:by |BkEynDYgM) (:text |:edn)
                      |h $ %{} :Leaf (:at 1749876260348) (:by |BkEynDYgM) (:text "|\"EDN")
          ...
          :data $ {}
            ...
            |v $ %{} :Expr (:at 1499755354983) (:by nil)
              :data $ {}
                ...
                |zY $ %{} :Expr (:at 1749876413799) (:by |BkEynDYgM)
                  :data $ {}
                    |T $ %{} :Leaf (:at 1749876414706) (:by |BkEynDYgM) (:text "|\"fracturedjsonjs")
                    |b $ %{} :Leaf (:at 1749876415604) (:by |BkEynDYgM) (:text |:refer)
                    |h $ %{} :Expr (:at 1749876415894) (:by |BkEynDYgM)
                      :data $ {}
                        |T $ %{} :Leaf (:at 1749876417903) (:by |BkEynDYgM) (:text |Formatter)
